...
"""
INSTRUCȚIUNI DE FOLOSIRE (32-bit):

1. Instalează Python 32-bit (x86) și dependențele:
...
def build_executable():
    ...
    try:
        ...
        print("\nIMPORTANT:")
        print("   - Executabilul 32-bit se obține doar dacă rulezi cu Python 32-bit")
        print("   - Utilizator implicit: admin / admin123")
        print("   - Catalog.exe trebuie să existe la: C:\\AL500\\catalog\\bin\\Catalog.exe")
        print("   - Accesul la catalog se face prin HTTP (fără browser)")
        print("\n" + "=" * 60)
